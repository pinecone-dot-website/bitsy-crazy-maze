...
function populate_dialogs() {
    for ( var i = 0; i <= 3; i++ ) {
        let id = `ITM_${i}`;
        let text = mkv.generateText( 50 );
        dialog[ id ] = text;

        scriptInterpreter.Compile(id, text);
        
        console.log( 'populate_dialogs', id, dialog[ id ] );
    }
}
...
But I'm living proof that they do Because I found the answer And you can find the answer too They made me think I was crazy
...
I'll sow my seeds with a metric grosse No footsteps go beyond it I'll eat the dirt Where the rooster crows
Fresh rodeos, behold it Check your pulse in your teardrops
Make you a cyclops Breakin' the branches off your family tree
And a woman hot with worry slyly slipped a tin of stewing steak
Into the paper bag at her side And her face was white with fear in case her actions were observed
So she closed her eyes to keep her conscience blind My mind has changed my body's frame, but, God, I like it My heart's aflame, my body's strained, but, God, I like it
My mind has changed my body's frame, but, God, I like it My heart's aflame, my body's strained, but, God, I like it
Charge me your day rate I'll turn you out in kind When the moon is round and full
Gonna teach you tricks that'll blow your Mongrel mind Then she moved toward the exit clutching tightly at her paper bag
Perspiration trickled down her forehead And her heart it leapt inside her as the hand laid on her shoulder
She was led away bewildered and amazed Through her deafened ears the cash machines were shrieking on the counter
As her escort asked her softly for her name And a crowd of honest people rushed to help a tired old lady
Who had fainted to the whirling wooden floor. When, in the course of development, class distinctions have disappeared, 
